...
/**
 * This class create a JavaFX application with embedded Swing GUI. This example
 * illustrates how to embed a Swing content into a JavaFX application. It uses a
 * specialized class SwingNode introduced in JavaFX 8. The content to be
 * displayed is specified with the setContent(javax.swing.JComponent) method
 ...
 * JComponent instance transparently to the developer. It is also possible to
 * embed JavaFX in Swing using javafx.embed.swing.JFXPanel see link:
...
public class SwingJavaFX extends Application {
	...
	/**
	 * This method creates a Swing GUI and embeds it in a JavaFX SwingNode
	 * component.
	 * 
	...
	/**
	 * This class is used to create a Swing GUI. It is the same class used in Lab 1
	 * Example 3.
	 */
	private class SwingGUI extends JPanel {
		...
		private JButton createButton(String buttonName) {
			...
			button.setFont(new Font(button.getFont().getName(), button.getFont().getStyle(), 20));// resize the font to
																									// size 20
			// Set a specific font
