...
/**
 * This is an example of how a typical GUI application should be coded. The
 * application class extends JPanel not JFrame. By doing that the application
 * can be deployed both as an applet and a desktop application. Also, by
 * extending JPanel, the Swing GUI can be easily incorporated in a JavaFX
 * Application (Example 5SFX - SwingJavaFX.java). The example shows how to
 * change the default "Look and Feel" of a Swing GUI application. It shows how
 * to change the standard text font. It shows how to attach mnemonics and
 * tooltips to a button. It uses anonymous inner class to handle the button
 * event. Pay attention how the main() method uses EventQueue.invokeLater()
 * method. This is the standard way to run a GUI application.
 * 
...
public class SimpleSwingGUIe3 extends JPanel implements Serializable {
	 ...
	 */
	private transient UIManager.LookAndFeelInfo[] installedLF;
	...
	/**
	 * Sets the GUI. This method is called from within the constructor to initialize
	 * the GUI.
	 */
