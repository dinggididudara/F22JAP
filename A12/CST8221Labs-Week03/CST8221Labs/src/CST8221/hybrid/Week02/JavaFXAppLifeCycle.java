...
/**
 * This class demonstrates the life-cycle of a JavaFX application. and how to
...
public class JavaFXAppLifeCycle extends Application {
	...
	/**
	 * Override the init() method. This method is called first when a JavaFX
	 * appplication is launched. As the name implies, this method can be used for
	 * initialization purposes only. No GUI elements can be created inside this
	 * method. Overriding the init() method is not necessary because a default empty
	 * implementation is provided by the Application class.
	 */
	@Override
	public void init() {
	...
	/**
	 * Override the start() method. This method must always be overridden. The GUI
	 * should be created inside that method.
	 */
	@Override
	public void start(Stage primaryStage) {
		...
		if (parameters.isEmpty())
			...
			/*
			 * parameters.stream().forEach((p) -> { System.out.println(p); });
			 */
		} // end else
	...
	/**
	 * Override the stop() method. This method is called when the application is
	 * closed. It can be used for closing resources or for safely shutting down the
	 * application. Overriding the init() method is not necessary because a default
	 * empty implementation is provided by the Application class.
	 */
	@Override
	public void stop() {
